...
class TestNormalizeFuncKey:
    ...
    def test_unrestricted_b3lyp_d3bj(self):
        assert normalize_func_key("UB3LYP-D3(BJ)") == "B3LYP"

    def test_unrestricted_m062x_d30(self):
        assert normalize_func_key("UM06-2X-D3(0)") == "M062X"
